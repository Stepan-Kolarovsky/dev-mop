...
class LoginPresenter extends Presenter
{
	...
	public function __construct(Google $google, GoogleUserFacade $userRepository, UserFacade $userFacade, OrderFacade $orderFacade, ProductFacade $facade)
	{
	...
	public function rendeGoogle(): void
	{
		$this->template->categories = $this->facade->getAllCategories();
	}
